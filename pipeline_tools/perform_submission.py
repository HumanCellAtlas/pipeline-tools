...
def perform_submission(submit_url, analysis_protocol_path, analysis_process_path, raw_schema_url,
                       analysis_file_version):
    """Perform the submission action in Ingest service.
...
def main():
    ...
    perform_submission(submit_url=args.submit_url,
