...
class TestInputUtils(object):
    ...
    def test_get_expected_cell_count_sets_default_value(
        ...
        total_estimated_cells = input_utils.get_expected_cell_count(
    ...
    def test_get_urls_to_files_for_ss2(
        ...
        fastq_url1, fastq_url2 = input_utils.get_urls_to_files_for_ss2(
            test_ss2_bundle_vx
        )
        assert (
            fastq_url1
    ...
    def test_download_file(self, requests_mock, test_ss2_bundle_manifest_vx):
        ...
        with HttpRequestsManager():
            file_name, file_response_js = input_utils.download_file(
    ...
    def test_create_ss2_input_tsv(
        ...
        with patch(
            'pipeline_tools.input_utils._get_content_for_ss2_input_tsv',
