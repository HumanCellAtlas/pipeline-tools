...
def test_data():
    class Data:
        ...
        output_file_path = f'{Path(os.path.split(__file__)[0]).absolute().parents[1]}/updated-data/staging/metdata/outputs.json'
        ...
        analysis_process_path = f'{Path(os.path.split(__file__)[0]).absolute().parents[1]}/updated-data/staging/metdata/analysis_process/151fe264-c670-4c77-a47c-530ff6b3127b_2021-05-24T12:00:00.000000Z.json'
        analysis_protocol_path = f'{Path(os.path.split(__file__)[0]).absolute().parents[1]}/updated-data/staging/metdata/analysis_protocol/f2cdb4e5-b439-5cdf-ac41-161ff39d5790_2021-05-24T12:00:00.000000Z.json'
