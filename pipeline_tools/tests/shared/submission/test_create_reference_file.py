...
class TestCreateReferenceFile(object):
    def test_build_reference_file(self, test_data):
        ...
        assert(reference_file['provenance']['document_id'] == "ad349b1d-270d-50ba-b99b-cc9df4a9359c")
        assert(reference_file['provenance']['submission_date'] == "2021-05-24T12:00:00.000000Z")
