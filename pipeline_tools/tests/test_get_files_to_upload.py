...
def test_data():
    class Data:
        files = ['gs://foo/call-Star/Aligned.sortedByCoord.out.bam', 'gs://foo/GSM1957573_rna_metrics']
...
class TestCheckStagedFiles(object):
    ...
    def test_files_to_upload(self, test_data):
        ...
        result = get_files_to_upload.get_files_to_upload(test_data.files, uploaded_files)
